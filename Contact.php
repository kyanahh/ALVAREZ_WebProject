...
<body>
        ...
        <div class="container-fluid bg-light" style="margin-top: 60px;">
            <div>
                <h1 class="text-center p-5 fs-2">How can we help?</h1><hr>
            </div>
        </div>
        <div class="container-fluid mt-5">
            <div class="card p-3 mx-auto" style="width: 600px;">
            <div class="text-center">
                <img class="my-5" src="https://static.vecteezy.com/system/resources/previews/009/973/213/original/email-and-mail-icon-sign-symbol-design-free-png.png" style="height: 150px;">
                <p>Send us a message or question and we’ll help you as soon as we can.</p>
            </div>
            <div class="text-center-left ms-5">
                <div class="row">
                <a href="https://facebook.com/KiannaAlvarezzz" style="text-decoration: none;"><i class="bi bi-facebook me-2"></i>Kianna Dominique Alvarez</a>
                </div>
                <div class="row">
                <a href="mailto:alvarezkiannadominique_bsit@plmun.edu.ph" style="text-decoration: none;"><i class="bi bi-google me-2"></i>alvarezkiannadominique_bsit@plmun.edu.ph</a>
                </div>
                <div class="row">
                <a href="https://www.youtube.com/@kiannaalvarez" style="text-decoration: none;"><i class="bi bi-youtube me-2"></i>KIANNA</a>
                </div>
            </div>
            </div>
        </div>
